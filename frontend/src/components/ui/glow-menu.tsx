      ...
      >
        ...
        <div className="flex items-center justify-between w-full relative z-10">
          <div className="flex-shrink-0 flex items-center justify-center pl-2 md:pl-4">
            <img src={logoImg} alt="Kapya" className="h-10 sm:h-12 w-auto object-contain drop-shadow-md" />
          </div>
          
          <ul className="flex items-center gap-1 sm:gap-2 justify-center flex-1 px-2 sm:px-4">
                ...
                <motion.li key={item.label} className="relative">
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        className={cn(
                          "flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 relative z-10 bg-transparent transition-colors rounded-xl",
                          isActive
                            ? "text-foreground"
                      ...
                      <motion.div
                        className={cn(
                          "flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 absolute inset-0 z-10 bg-transparent transition-colors rounded-xl",
                          isActive
                            ? "text-foreground"
                            : "text-muted-foreground group-hover:text-foreground",
                        )}
          ...
          <ul className="flex items-center gap-2 flex-shrink-0 pr-2 md:pr-4">
            {items.filter(item => item.href === '/settings').map((item) => {
              const Icon = item.icon
              const isActive = item.label === activeItem
