        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Select defaultValue="delivery">
              ...
              <SelectContent>
                <SelectItem value="delivery">Paket Servis</SelectItem>
                <SelectItem value="dine-in">Restoran İçi</SelectItem>
              </SelectContent>
            </Select>
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex items-end justify-between gap-4 mb-4">
            <div>
              ...
              >
                {percentageChange > 0 ? "▲" : "▼"} {Math.abs(percentageChange)}% geçen döneme göre
              </p>
            </div>
            <div className="w-1/2">
          ...
          <div className="space-y-3 mb-6">
            <h3 className="text-sm font-medium">Temel rakipler (Örnek)</h3>
          ...
          <div className="space-y-3 mb-6">
            <h3 className="text-sm font-medium flex items-center gap-2">
              ...
              <span>Performans seviyeleri</span>
            </h3>
